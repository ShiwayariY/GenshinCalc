...
const std::vector<Artifact> YAE_ARTS{
	{ Main::Flower, SetType::GildedDreams, // off-set
	  { StatusRoll::EM, 23.0 },
	  { StatusRoll::CRate, 3.9 },
	  { StatusRoll::CDmg, 38.1 },
	  { StatusRoll::ER, 5.2 } },
	{ Main::Feather, SetType::GildedDreams,
	  { StatusRoll::EM, 47.0 },
	  { StatusRoll::CRate, 2.7 },
	  { StatusRoll::ER, 11.7 },
	  { StatusRoll::CDmg, 20.2 } },
	{ Main::SandAtk, SetType::GildedDreams,
	  { StatusRoll::CDmg, 14.8 },
	  { StatusRoll::CRate, 6.6 },
	  { StatusRoll::ER, 16.8 },
	  { StatusRoll::Def, 16.0 } },
	{ Main::GobletElectro, SetType::GildedDreams,
	  { StatusRoll::DefPerc, 17.5 },
	  { StatusRoll::HPPerc, 5.8 },
	  { StatusRoll::HP, 269.0 },
	  { StatusRoll::CDmg, 21.0 } },
	{ Main::HeadCDmg, SetType::GildedDreams,
	  { StatusRoll::CRate, 10.1 },
	  { StatusRoll::HPPerc, 10.5  },
	  { StatusRoll::Atk, 31.0 },
	  { StatusRoll::Def, 39.0 } }
