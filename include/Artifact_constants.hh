...
const std::vector<Artifact> YELAN_ARTS{
	...
	{ Main::Flower, SetType::Emblem,
	  ...
	  { StatusRoll::CRate, 6.6 },
	  { StatusRoll::Atk, 51 } },
	{ Main::Flower, SetType::Emblem, // Raiden -- Skill -- Burst
	  { StatusRoll::HPPerc, 4.7 },
	  { StatusRoll::CDmg, 28.7 },
	  { StatusRoll::ER, 9.1 },
	  { StatusRoll::CRate, 3.1 } },
	{ Main::Flower, SetType::Emblem, // Xingqiu
	  ...
	  { StatusRoll::CDmg, 12.4 },
	  { StatusRoll::CRate, 6.2 } },
	{ Main::Flower, SetType::Emblem, // Yanfei
	  { StatusRoll::ER, 13.0 },
	  { StatusRoll::Def, 19.0 },
	  { StatusRoll::CRate, 6.6 },
	  { StatusRoll::HPPerc, 18.7 } },
	...
	{ Main::Flower, SetType::HeartOfDepth, // Mona
	  ...
	  { StatusRoll::ER, 9.7 },
	  { StatusRoll::CDmg, 12.4 } },
	{ Main::Flower, SetType::HeartOfDepth, // Lvl 16 -- Barb
	  { StatusRoll::CDmg, 7.8 },
	  { StatusRoll::CRate, 3.9 },
	  { StatusRoll::ER, 16.2 },
	  { StatusRoll::HPPerc, 9.3 } },
	...
	{ Main::Feather, SetType::Emblem,
	  ...
	  { StatusRoll::EM, 19.0 },
	  { StatusRoll::AtkPerc, 8.2 } },
	{ Main::Feather, SetType::Emblem, // Yanfei -- Skill -- Burst
	  { StatusRoll::HP, 209.0 },
	...
	{ Main::Feather, SetType::Emblem, // Beidou
	  ...
	  { StatusRoll::ER, 11.4 },
	  { StatusRoll::CDmg, 7.8 } },
	// { Main::Feather, SetType::Emblem, // Raiden
	//   { StatusRoll::ER, 11.0 },
	//   { StatusRoll::CRate, 10.1 },
	//   { StatusRoll::Def, 19.0 },
	//   { StatusRoll::CDmg, 20.2 } },
	...
	{ Main::Feather, SetType::HeartOfDepth, // Lv 16
	  ...
	  { StatusRoll::HP, 299.0 },
	  { StatusRoll::ER, 18.1 } },
	{ Main::Feather, SetType::HeartOfDepth, // -- Barb
	  { StatusRoll::AtkPerc, 9.3 },
	  { StatusRoll::CRate, 3.9 },
	  { StatusRoll::CDmg, 12.4 },
	...
	{ Main::SandHP, SetType::Emblem,
	  ...
	  { StatusRoll::CRate, 3.1 },
	  { StatusRoll::EM, 61.0 } },
	{ Main::SandHP, SetType::Emblem, // -- Burst
	  { StatusRoll::ER, 11.0 },
	  { StatusRoll::Atk, 16.0 },
	  { StatusRoll::Def, 39.0 },
	  { StatusRoll::CDmg, 19.4 } },
	...
	{ Main::SandHP, SetType::Millileth,
	  ...
	  { StatusRoll::Atk, 39.0 },
	  { StatusRoll::CDmg, 11.7 } },
	{ Main::SandHP, SetType::HeartOfDepth, // -- Barb -- Skill
	  { StatusRoll::CDmg, 15.5 },
	  { StatusRoll::CRate, 9.3 },
	  { StatusRoll::HP, 478.0 },
	  { StatusRoll::EM, 16.0 } },

	{ Main::GobletHydro, SetType::Shimenawa, // -- Skill -- Burst
	  { StatusRoll::HP, 598.0 },
	...
	{ Main::GobletHydro, SetType::Shimenawa,
	  ...
	  { StatusRoll::Def, 35.0 } },
	{ Main::GobletHydro, SetType::Bloodstained, // -- Barb
	  { StatusRoll::Atk, 29.0 },
	...
	{ Main::HeadCDmg, SetType::Emblem,
	  ...
	  { StatusRoll::CRate, 2.7 },
	  { StatusRoll::AtkPerc, 10.5 } },
	// { Main::HeadCDmg, SetType::Emblem, // Raiden
	//   { StatusRoll::Atk, 16.0 },
	//   { StatusRoll::CRate, 17.1 },
	//   { StatusRoll::EM, 40.0 },
	//   { StatusRoll::HPPerc, 4.7 } },
	...
	{ Main::HeadHP, SetType::Millileth,
	  ...
	  { StatusRoll::HP, 807.0 },
	  { StatusRoll::CRate, 6.6 } },
	{ Main::HeadCDmg, SetType::HeartOfDepth, // -- Barb -- Skill
